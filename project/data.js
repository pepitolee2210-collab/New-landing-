...
(function () {
  ...
  const ICONS = {
    appeal: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7h7M6.5 7v10M3.5 12.5h6M21 7h-7M17.5 7v10M14.5 12.5h6M12 3v2"/><path d="M12 5l8 2-8 2M12 5L4 7l8 2"/></svg>',
    child: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="6" r="3"/><path d="M12 9v6M8 21v-5l-2-1.5M16 21v-5l2-1.5M9 14h6"/></svg>',
    folder: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><path d="M9 13h6"/></svg>',
    card: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M3 10h18M7 15h4"/></svg>',
    ...
    shieldPlus: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l7 3v5c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6z"/><path d="M12 8v6M9 11h6"/></svg>',
    ...
    receipt: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M6 3h12v18l-2-1.3-2 1.3-2-1.3-2 1.3-2-1.3L6 21z"/><path d="M9 8h6M9 12h6M9 16h3"/></svg>',
  };
  ...
  // ---- Servicios ----
  // tone: 'success' (califica) | 'contact' (no califica, igual lo invitamos a WhatsApp)
  const SERVICES = [
    {
      id: 'visa-juvenil',
      icon: 'child',
    ...
    },
    {
      ...
      questions: [
        { id: 'tiempo', kind: 'choice', text: '¿Cuánto tiempo llevas dentro de los Estados Unidos?',
          options: [
    ...
    },
    {
      ...
      questions: [
        { id: 'dias', kind: 'choice', text: '¿Hace cuántos días el juez negó tu caso?',
          options: [
            { value: '1-10', label: 'Entre 1 y 10 días',
              tone: 'success', message: '¡Felicidades, estás a tiempo! Podemos hacer un trabajo minucioso y paciente para tu apelación.' },
            { value: '10-20', label: 'Entre 10 y 20 días',
              tone: 'success', message: 'Ya pasaron unos días, pero todavía estás a tiempo. Contáctanos hoy: no dejes pasar más tiempo.' },
            { value: '20-30', label: 'Entre 20 y 30 días',
              tone: 'urgent', message: 'El tiempo se está agotando. Estás en el momento crítico para decidir — hazlo ahora.' },
            { value: '30-mas', label: 'Más de 30 días',
              tone: 'contact', message: 'El plazo legal de 30 días podría haber vencido, pero existen excepciones. Escríbenos para revisar tu caso de inmediato.' },
          ] },
      ],
      evaluate(a, svc) {
        const opt = svc.questions[0].options.find((o) => o.value === a.dias);
        return { tone: opt ? opt.tone : 'contact', message: opt ? opt.message : '' };
      },
    },
    {
      id: 'cambio-corte',
    ...
    },
    {
      ...
      questions: [
        { id: 'docs', kind: 'checklist', text: 'Marca los documentos que ya tienes listos:',
          items: [
